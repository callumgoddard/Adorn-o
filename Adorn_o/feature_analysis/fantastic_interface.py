...
def compute_features_folder(mcsv_folder, write_out=True):
    """
    Compute the fantastic features for the mcsv files in mcsv_folder
    """
    # assert isinstance(mcsv_file_list, list), "Must be a list of mcsv files"

    # call the compute features and return the dataframe
    return robjects.r["compute.features"](dir=mcsv_folder, write_out=write_out)
