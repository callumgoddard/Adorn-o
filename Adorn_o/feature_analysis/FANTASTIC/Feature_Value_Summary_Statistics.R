...
# Needed to set poly.contour=FALSE instead of true as there are 
# isssues with the poly.countours tending to infinity.
summary.phr.features <- function(phr.data,poly.contour=FALSE){
