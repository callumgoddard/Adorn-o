...
from .calculate_functions import calculate_physical_model_note_structures
from .get_functions import get_song_data
...
def gp5_to_audio(gp5_file, file_name, matlab_engine, fs=44100.00):
    ...
    for track in api_test_song:
        file_name = file_name.split(".wav")[0] + "_track_" + str(track_number) + ".wav"
...
def add_physical_files_to_path(matlab_engine, path="bass_guitar_waveguide_model"):
